...
<div class="row get-started-bg">
    <div class="get-started-content">
       ...
       <ul>
           <li data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><span class=""></span>How do I join a meeting/class?</li>
          ...
          <li data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample2"><span class=""></span>What is a meeting ID or link?</li>
         ...
         <li data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample3"><span class=""></span>Do I need to have a webcam to join a meeting?</li>
        ...
        <li data-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample4"><span class=""></span>Am I able to join from an area with poor Internet connectivity?</li>
       ...
       <li data-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample5"><span class=""></span>If I have no access to Internet, can I join by dialing in?</li>
      ...
      {{-- 6 --}}
      <li data-toggle="collapse" href="#collapseExample6" role="button" aria-expanded="false" aria-controls="collapseExample6"><span class=""></span>Do I have the option of audio meeting only?</li>
     ...
     {{-- 7 --}}
     <li data-toggle="collapse" href="#collapseExample7" role="button" aria-expanded="false" aria-controls="collapseExample7"><span class=""></span>If I choose to use audio and video, how do I activate both of them?</li>
    ...
    {{-- 8 --}}
    <li data-toggle="collapse" href="#collapseExample8" role="button" aria-expanded="false" aria-controls="collapseExample8"><span class=""></span>Can I use either a phone or my computer to join?</li>
    <div class="collapse" id="collapseExample8">
        QXP platform is mobile optimized which means you can join in from your phone or your computer.
   </div>
   {{-- 9 --}}
   <li data-toggle="collapse" href="#collapseExample9" role="button" aria-expanded="false" aria-controls="collapseExample9"><span class=""></span>How do I schedule a meeting on QXP?</li>
