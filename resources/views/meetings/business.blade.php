                ...
                <div class="col-md-4">
                    <div class="meeting-landing-pg-desc business">
                        ...
                        <a href="#business-link">
                            <button style="background-color: #c92519">Get Started</button>
                        </a>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="meeting-landing-page">
                        ...
                        <img src="{{asset('images/business/QXP-business-laptop.png')}}" alt="">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="img-banner">
                        <img src="{{asset('images/business/QXP-business-desktop.png')}}" alt="">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="img-banner-desc">
                        <div class="desc-content-meeting-logo"><img src="{{asset('images/logo/bgAsset-1-1.svg')}}" alt=""></div>
