    ...
    <div class="container">
      <div class="row">
         ...
         <div class="col-md-4 my-footer">
            <div class="row">
                  <a href="/register"><button class="btn btn-primary">SIGN UP ITS FREE</button></a>
                  <a href="pricing"><button class="btn btn-warning" style="margin-left: 6px;">SEE PRICING</button></a>
            </div>
         </div>
      </div>
    </div>
